<script>
  ...
  $: organizationSchema = JSON.stringify({
    ...
    url: siteConfig.url,
    logo: `${siteConfig.url}/assets/as-logo.svg`,
...
<svelte:head>
  ...
  <!-- Enhanced Meta Tags -->
  <meta name="keywords" content="Ayish Shaikh, software engineer, data science, portfolio, AI, machine learning, full-stack development, Python, JavaScript" />

  ...
  async function fetchGitHubData() {
    ...
    try {
      ...
      const response = await fetch(
        'https://api.github.com/repos/Ayish-Shaikh/Ayish-Shaikh.github.io/commits?per_page=100'
      );
  ...
  <div class="widget-row responsive-widget-row">
    ...
    <div class="widget location-widget" bind:this={widgetElement}>
      ...
      <div class="location-content">
        ...
        <div class="location-footer">
          <div class="location-label">Kolkata, India</div>
          <div 
            class="time-display" 
    ...
    <div class="widget contact-widget">
      ...
      <div class="contact-content">
        ...
        <a href="https://cal.com/ayish-shaikh-zvap1d/15min" target="_blank" class="book-chat-btn">

  ...
  const showcases = [
    {
      ...
      description:
        "A creative browser-based terminal emulator with real command parsing, virtual file system, and session persistence—zero dependencies, pure frontend engineering.",
      url: "https://terminal.ayishshaikh.vercel.app",
      github: "https://github.com/Ayish-Shaikh/terminal",
    ...
    },
    {
      ...
      description:
        "Production-grade security system with device fingerprinting, Proof of Work challenges, and hardware attestation protecting high-value API endpoints.",
      url: "https://api.ayishshaikh.vercel.app",
      github: "https://github.com/Ayish-Shaikh/api-gateway",
    ...
    },
    {
      ...
      projectSlug: "straits",
      description:
        "Real-time dashboard tracking the Strait of Hormuz crisis with live commodity prices, maritime incidents, and economic impact analysis through interactive data visualization.",
      url: "https://straits.ayishshaikh.vercel.app",
      github: "https://github.com/Ayish-Shaikh/straits",
...
<section class="live-showcases">
  <div class="section-header">
    ...
    <p class="section-subtitle">
      Interactive demonstrations of frontend skills and technical expertise
    </p>
  </div>
              ...
              <div class="skills">
                ...
                <div class="skills-tags">
                  {#each showcase.skills as skill}
                    <span
                      class="skill-tag"
                      style="--skill-color: {showcase.color}"
                    >
                      {skill}
                    </span>
                  {/each}
            ...
            <div class="showcase-preview">
              <div class="preview-header">
                ...
                <span class="preview-url"
                  >{showcase.url.replace("https://", "")}</span
                >
              </div>
                ...
                {#if iframeError}
                  <div class="iframe-error">
                    ...
                    <p class="error-message">
                      This site restricts embedding in iframes for security
                      reasons
                    </p>
                    <p class="error-hint">
                      Visit the live site using the button below to explore it
                    </p>
                    <a
                      href={showcase.url}
                      target="_blank"
